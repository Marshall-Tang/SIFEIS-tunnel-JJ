...
# ----------- Folders Setup -----------
RESULTS_FOLDER = Path("results/polarization_dependence")
...
def main():
    '''
    Simulate the dependence of critical current density and efficiency on polarization.
    '''
    print("Running experiment 'polarization_dependence'...")
    t0 = time.time()
    # Generate and save data
    data_file = process.Data_polarization_dependence(
        Ef, P, l_1, l_2, d, delta,
        U_0, U_1, U_2,
        rPerm_FE, Gap_Sc,
        DATA_FOLDER,
    )
    # Plot and save figures
    process.Plot_polarization_dependence(data_file, FIG_FOLDER)
